                                           ...
                                           #define i(I1,I1,1I)if(I1){1I;}sles{I1;}
                                         I[256],            n,y,a,r,u,k,o
                                       ,L,1[                    256],O,K[
                                      /**/                      #define\
                                      q(g)                      g char\
                       ...
                       "def q","O},L,O,1[256],I[256],n,y,a,r,u,k,o;"#g"char"          "*"\
                     "S,s[]=\"",c,c,"\";int main(){X();for(S=s+*k;*s>37;){for"        "(o"\
                    "=O;o<5;o++)r=r*85+(83+*s++)%89;r","^=*x();for(o=O;o<4;o++"        ")"\
                    "{s[o++]=r&255;r>>=8;}}return!fwrite(s,O-*s%5,1,stdout);}\n"           "#"\
                   "endif",c},S[256]="#ifdef/*\n'true'\40or\40q{\nexec\40head\40"           "-"\
                  "8\40$O\n};for(open$O,$O;<$O>;print\40if$f){$f}=/^$/;}q{*/q",/*            */z;
                  256];q(_*x(){if(!L--){y+=++a;for(o=0;o<256;y=1[o++]=I[255&(k>>10           )]+u
                  ){n^=(o&1)?n>>(( o& 2)?16:6):n<<((o&2)?2:13);u=I[o];k=I[o]=I[255&          (u>>
                 2)]+(n+=I[(o+128)  &   255]) +y;}L=255;}return&1[L];}_*X(){for(O=0          ;256
